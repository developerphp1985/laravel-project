...
class SendWithDrawalConfirmation extends Notification
{

    use Queueable;

    protected $currency_name, $amount, $wallet_address;
    ...
    public function toMail($notifiable)
    {
        ...
        $message->subject(trans('emails.withdrawalConfirmedSubject'))
				...
				->line(trans('emails.withdrawalConfirmedSecondParagraph', ['address'=>$this->wallet_address]))
