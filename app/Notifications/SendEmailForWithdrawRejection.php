...
class SendEmailForWithdrawRejection extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        $message->subject(trans('emails.withdrawalApproveRejectSubject',['status'=>$this->status]))
				...
				->line(trans('emails.withdrawalRejectSecondParagraph', ['address'=>$this->wallet_address,'status'=>$this->status]))
